...
const navItems: NavItem[] = [
  ...
  { label: 'Operations', path: '/operations', icon: <Gauge className="h-5 w-5" /> },
  { label: 'Fleet', path: '/fleet', icon: <Plane className="h-5 w-5" /> },
  { label: 'Airports', path: '/airports', icon: <Globe className="h-5 w-5" /> },
  { label: 'Missions', path: '/missions', icon: <MapPin className="h-5 w-5" /> },
  { label: 'Dispatch', path: '/dispatch', icon: <FileSpreadsheet className="h-5 w-5" /> },
  ...
  { label: 'Maint Control', path: '/maint-control', icon: <ShieldCheck className="h-5 w-5" /> },
  { label: 'Personnel', path: '/crew', icon: <Users className="h-5 w-5" /> },
